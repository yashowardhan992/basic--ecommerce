      ...
      {isEmpty && (
        <div className="flex flex-row justify-center px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <div className="w-fit flex flex-col   ">
            ...
            <h3 className="mx-2">Your shopping bag is empty</h3>
            <a href="/product">
              <button
                type="button"
                className="flex items-center m-2 justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
              >
                Continue Shopping
              </button>
            </a>
