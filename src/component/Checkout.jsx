        ...
        <div className="flex flex-col justify-center">
          <div className="mx-auto max-w-2xl text-center ">
            ...
            <p className="mt-2 text-lg leading-8 text-gray-600">
              Enter your credentials to place your order.
            </p>
          </div>
          <form action="/exit" className="mx-auto mt-16 max-w-xl sm:mt-20">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2.5">
                  <textarea
                    ...
                    className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    defaultValue={
                      "Please mention any additional details to facilitate our delivery partners."
                    }
                  />
                </div>
              </div>
              <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
                ...
                <Switch.Label className="text-sm leading-6 text-indigo-600">
